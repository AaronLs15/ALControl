...
export function TablaProductos({
  ...
  const columns = [
    ...
    },
    {
      accessorKey: "p_venta",
      header: "P.venta",
      cell: (info) => <td data-title="P.venta" className="ContentCell">
        <span>{info.getValue()}</span>
      </td>,
      enableColumnFilter: true,
      filterFn: (row, columnId, filterStatuses) => {
    ...
    },
    {
      ...
      header: "P.compra",
      cell: (info) => <td data-title="P.compra" className="ContentCell">
        <span>{info.getValue()}</span>
      </td>,
      enableColumnFilter: true,
      filterFn: (row, columnId, filterStatuses) => {
    ...
    },
    {
      ...
      header: "Se vende por",
      cell: (info) => <td data-title="Se vende por" className="ContentCell">
        <span>{info.getValue()}</span>
      </td>,
      enableColumnFilter: true,
      filterFn: (row, columnId, filterStatuses) => {
    ...
    },
    {
      ...
      header: "Inventarios",
      cell: (info) => <td data-title="Inventarios" className="ContentCell">
